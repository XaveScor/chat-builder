...
export type NonFunction = {} | string | number | boolean

type MapPrevousPageF<TProps, T: NonFunction> = (PrevousPageResult<TProps>, (void) => TProps) => Promise<T> | T
export type MapPrevousPage<TProps, T: NonFunction> = MapPrevousPageF<TProps, T> | T
...
type CreatePageArg<TProps> =
	| string
	| SchemeFunction<TProps>
	| {|
			name?: string,
			props?: Props<TProps>,
	  |}
export function createPage<TProps>(arg?: CreatePageArg<TProps>): Page<TProps> {
